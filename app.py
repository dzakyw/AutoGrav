...
def nagy_tc(e0,n0,z0,dem,density,maxr=10000,cell=None):
    dx = dem["Easting"]-e0
    dy = dem["Northing"]-n0
...
st.sidebar.write("[Catatan Penting Di Baca](https://github.com/dzakyw/AutoGrav/blob/main/readme.txt)")
...
st.sidebar.write("[Contoh Data Input Gravitasi](https://github.com/dzakyw/AutoGrav/blob/main/sample_gravity.xlsx)")
